"""Evaluate the fine-tuned bert-base-uncased checkpoint produced by
fine_tune_bert.py, using the same held-out slice of train.csv as
evaluate_base.py and evaluate_detoxify.py so the AUC/accuracy numbers are
